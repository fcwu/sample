...
try:
    ...
    sys.stderr.write('argparse not found: try "sudo apt-get install python-argparse"')
    sys.exit(1)
try:
    import gtk as Gtk
    import gobject as GObject
except ImportError:
    sys.stderr.write('gtk not found: try "sudo apt-get install python-gtk2 python-gobject"')
    sys.exit(1)
...
class AutoLoginConfigurator(object):
    ...
    """
    CONFIG_FILENAME = '/etc/gdm/custom.conf'
    TEMPLATE = """
[daemon]
